...
class sensor:
   ...
   def read_data(self, tempUnit=CELSIUS, pressUnit=PASCALS):
      """
...
if __name__ == "__main__":
   ...
   #s = sensor(pi, sampling=OVER_SAMPLE_4,
   #          interface=SPI, channel=1, flags=AUX_SPI, baud=10000)
   s = sensor(pi, interface=SPI)
